...
def squash_vector(tensor, dim=-1):
    """Non-linear 'squashing' to ensure short vectors get
    shrunk to almost zero length and long vectors get shrunk
...
def softmax(input, dim=1):
    """Apply softmax to specific dimensions. Not released on
    PyTorch stable yet as of November 6th 2017
...
if __name__ == '__main__':
    ...
    train_images, train_labels = mnist_loader.train(5000)
    test_images, test_labels = mnist_loader.test(1000)
